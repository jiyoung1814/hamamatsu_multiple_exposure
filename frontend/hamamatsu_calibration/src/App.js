...
import XCalibrating from './component/XCalibrating';
...
function App() {
  ...
  const sendPacket = async() =>{
    ...
    for(let i=0;i<packetobj.length;i++){
    ...
    <div className='app'>
      ...
      <div className="header">
        ...
        <div className="header-menu">
          ...
          <Link to ="/xCalibrating" id='opt-2' className="menu-link" onClick={(e)=>menuLinkAnimation(e)}>XCalibrating</Link>
      ...
      <div className="wrapper">
        ...
        <div className="main-container">
          <div className="content-wrapper">
            <Routes>
              <Route path='/' element={<RawData serialRead ={serialRead} modeBtn = {modeBtn}></RawData>}></Route>
              <Route path='/xCalibrating' element={<XCalibrating></XCalibrating>}></Route>
